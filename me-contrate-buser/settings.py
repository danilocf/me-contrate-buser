"""
Django settings for me-contrate-buser project.
...
ROOT_URLCONF = 'me-contrate-buser.urls'
...
WSGI_APPLICATION = 'me-contrate-buser.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './me-contrate-buser.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
